/**
 * agents-anywhere export — generate a standalone install.sh script that sets up
 * agent configs without requiring agents-anywhere to be installed.
 *
 * Reads the current agents-anywhere.json manifest and mcp.json, transforms MCP
